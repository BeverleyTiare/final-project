  ...
  return (
    <div className="container mx-auto">
      ...
      <img src="./assets/Health.png" alt="nature scene" />
        ...
        <br />
        <br />  
        The life-long plasticity of the brain supports everyday learning: a lack of use of brain functions can lead to degeneration, while training of a specific function can lead to enhancement of the specific function.
        <br /> 
        <br /> 
        However, training requires a suitable intensity and level of repetition across time.
        <br /> 
        <br /> 
        Developing brains prune and strengthen synapses in response to our environment, and mature brains also have a degree of plasticity. 
        <br /> 
        <br /> 
        But change in mature brains requires attention, positive challenge and connection to be optimal.
        <br /> 
        <br />  
        ...
        <p className="my-4 text-white" style={{ textAlign: 'left', paddingRight: '20%' }}>
        Our brain is the powerhouse of regulating function, interpretating sensory information, emotion processing, and the foundation of intelligence, memory and creativity. 
        <br /> 
        <br /> 
        ...
        through regular exercise, a mostly plant-based diet, quality sleep, stress management, nurturing social interactions, and healthy mental stimulation.
        <br />
        <br />
        When our brains our healthy the improvements can be seen in our perception, attention, complex movement & coordination, memory & learning, emotion regulation, practical & social judgment, language, and visuo-spatial processing.
        <br />
        <br />
        We can improve our brain health through specific activities that engage the brain in novel ways can improve our cognitive function, memory & creativity i.e. meditation, visualisation (forming mental images to represent information), playing board games, jigsaw puzzles, sudoku, video games, listening to music, creating art, engaging in sports or dance and learning new skills such as a new language or a musical instrument.
        <br />
        <br />
        ...
        <p className="my-4" style={{ textAlign: 'left', color: 'lightblue', paddingBottom: '20%' }}>
                To learn some evidence-based tips to promote quality sleep & preventative healthcare complete our survey and receive your personalized sleep plan!
        </p>
      </div>
    </div>
  );
